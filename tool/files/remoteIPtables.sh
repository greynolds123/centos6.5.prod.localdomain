...
>>>>>>> 33066c155e36d3920b86b49b3b83bf3d859f07c8
 ...
 ssh root@$d  $cwd -A FORWARD  -p tcp -s $f --dport 8081 -j ACCEPT

 ssh root@$d  $cwd -A FORWARD  -p tcp -s $f --dport 749 -j ACCEPT

 ssh root@$d  $cwd -A FORWARD  -p tcp -s $f --dport 88 -j ACCEPT

 ssh root@$d  $cwd -A FORWARD  -p tcp -s $f --dport 389 -j ACCEPT

 ssh root@$d  $cwd -A FORWARD  -p udp -s $f --dport 69 -j ACCEPT
...
>>>>>>> 33066c155e36d3920b86b49b3b83bf3d859f07c8
 ...
 ssh root@$d  $cwd -A OUTPUT  -p tcp -s $o --dport 8080 -j ACCEPT
