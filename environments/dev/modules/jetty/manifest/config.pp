class jetty::config { 
     ...
     group   => "root",
     mode    => 0644,
     source  => 'puppet:///modules/nginx/jetty.ini',
     source  => templates("jetty/jetty.ini"),
      }
     }

exec { "change_port_for_jetty":
      command  => "/bin/cp ../templates/jetty.ini >  /etc/puppetlabs/puppetdb/conf.d/jetty.ini && /usr/bin/chattr +i /etc/puppetlabs/puppetdb/conf.d/jetty.ini",
